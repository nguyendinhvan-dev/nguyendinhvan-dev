<!-- ============================================================
     NGUYEN DINH VAN — GitHub Profile README
     Aesthetic: Luxury Dark / Editorial / Premium Dev Portfolio
     Palette: #0a0a0f (void) · #e8e8f0 (white smoke) · #c084fc (violet) · #818cf8 (indigo)
     ============================================================ -->
...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Sora&weight=600&size=18&duration=3000&pause=1000&color=c084fc&center=true&vCenter=true&width=580&height=36&lines=Solving+real-world+problems+through+code+%E2%9C%A6;ASP.NET+Core+%C2%B7+Clean+Architecture+%C2%B7+System+Design;Building+scalable+%26+maintainable+systems;Too+curious+to+stay+average.)](https://git.io/typing-svg)
...
{
    public string  Name       { get; } = "Nguyen Dinh Van";
    public string  Role       { get; } = "Backend Engineer";
    public string  Primary    { get; } = "C# / ASP.NET Core / .NET";
    public string  Arch       { get; } = "Clean Architecture + DDD";
    public string  University { get; } = "UTE – The University of Danang";
    public string  Location   { get; } = "Da Nang, Vietnam 🇻🇳";
    public bool    OpenToWork { get; } = true;
    public string  Slogan     { get; } = "Too curious to stay average.";
}
```
<br/>
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=nguyendinhvan-dev&bg_color=0d0d18&color=c084fc&line=818cf8&point=e8e8f0&area=true&area_color=12082a&hide_border=true&radius=8&custom_title=Contribution+Activity" width="96%"/>
...
<!-- ▓▓▓ FOOTER ▓▓▓ -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0a0a0f,25:312e81,50:7c3aed,75:c084fc,100:0a0a0f&height=120&section=footer" width="100%"/>
</div>
